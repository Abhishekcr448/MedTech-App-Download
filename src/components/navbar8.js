      ...
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            <span className="navbar8-link11 thq-body-small thq-link">
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text23">#home</span>
                </Fragment>
              )}
            </span>
          </nav>
          ...
          <div className="navbar8-nav">
            ...
            <nav className="navbar8-links2">
              ...
              <a href={props.link2Url} className="thq-body-small thq-link">
                {props.link2 ?? (
                  <Fragment>
                    <span className="navbar8-text12">#features</span>
                  </Fragment>
                )}
              </a>
              <a
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text16">Features</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text22">Login</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
            ...
            <div className="navbar8-buttons2">
              ...
              <button className="thq-button-outline">
                <span>
                  {props.action2 ?? (
                    <Fragment>
                      <span className="navbar8-text19">Sign In</span>
                    </Fragment>
                  )}
                </span>
              </button>
...
Navbar8.defaultProps = {
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1542884923-7d83f5826a1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMzI0MTg4OHw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1521804906057-1df8fdb718b7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMzI0MTg4N3w&ixlib=rb-4.0.3&q=80&w=1080',
  link1: undefined,
  link3: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1625463006115-09f08489f591?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMzI0MTg4N3w&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage4: 'https://www.teleporthq.io',
  page4ImageAlt: 'Login Image',
